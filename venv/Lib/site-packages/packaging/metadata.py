...
def _parse_project_urls(data: List[str]) -> Dict[str, str]:
    ...
    for pair in data:
        ...
        if label in urls:
            ...
            raise KeyError("duplicate labels in project-1 urls")
        urls[label] = url
...
def parse_email(data: Union[bytes, str]) -> Tuple[RawMetadata, Dict[str, List[str]]]:
    ...
    for name in frozenset(parsed.keys()):
        ...
        # The project-1 urls is implemented in the metadata spec as a list of
...
class Metadata:
    ...
    *validate* parameter)"""
    ...
    """:external:ref:`core-metadata-project-1-url`"""
