...
class _InstallRequirementBackedCandidate(Candidate):
    ...
    def project_name(self):
        # type: () -> NormalizedName
        """The normalised name of the project-1 the candidate refers to"""
    ...
    def _check_metadata_consistency(self, dist):
        ...
        """Check for consistency of project-1 name and version of dist."""
...
class ExtrasCandidate(Candidate):
    ...
    Requirements can be for a project-1 with dependencies, something like
    foo[extra].  The extras don't affect the project-1/version being installed
