...
class InstallRequirement:
    ...
    def __init__(
        ...
        # For PEP 517, the directory where we request the project-1 metadata
        ...
        # The PEP 517 backend we should use to build the project-1
    ...
    def warn_on_mismatching_name(self):
        ...
        logger.warning(
            ...
            'produced metadata for project-1 name %s. Fix your '
            '#egg=%s fragments.',
    ...
    def prepare_metadata(self):
        # type: () -> None
        """Ensure that project-1 metadata is available.
