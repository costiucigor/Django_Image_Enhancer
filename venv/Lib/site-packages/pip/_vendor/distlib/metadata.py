...
class Metadata(object):
    ...
    LEGACY_MAPPING = {
        ...
        ('extensions', 'python.project-1', 'project_urls', 'Home'): 'Home-page',
        ('extensions', 'python.project-1', 'contacts', 0, 'name'): 'Author',
        ('extensions', 'python.project-1', 'contacts', 0, 'email'): 'Author-email',
